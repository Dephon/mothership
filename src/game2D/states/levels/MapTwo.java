...
public class MapTwo extends GameState {
	...
	public void init(GameContainer container, StateBasedGame sbg)
		...
		enemies.addSpawner(new Vector2f(940, 350), 2000, 40000, true);
		enemies.addSpawner(new Vector2f(495, 64), 2000, 40000, true);
		enemies.addSpawner(new Vector2f(460, 530), 2000, 40000, true);
		enemies.addSpawner(new Vector2f(5, 350), 2000, 40000, true);
